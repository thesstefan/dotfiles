...
if [[ -f ~/.config/wlsunset/wlsunset_temp_value.sh ]]; then
...
echo "WLSUNSET_TEMP=$WLSUNSET_TEMP" > ~/.config/wlsunset/wlsunset_temp_value.sh

. ~/.config/wlsunset/restart_wlsunset.sh
